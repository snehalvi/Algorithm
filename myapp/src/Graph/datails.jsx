...
class Details extends Component {
    ...
    Switcherr = () => {
        switch (this.props.algo) {
            case 0:
                return <div className='row bg-info m-1 p-3'>
                    <div className='col-3  card me-4 bg-light '>
                    ...
                    <div className='col-2 card me-0 bg-light'>
                        Fib(0) = 0 <br/>
                        Fib(1) = 1 <br/>
            ...
            case 2:
                return <div className='row bg-info m-1 p-3 '>
                    ...
                    <div className='col-2  card me-4 bg-light '>
                        der(0) = 1 <br/>
                        der(1) = 0 <br/>
